...
int Task_lteTurboDecode_1(
    ...
    // vbrdcst(softin2_x_B,0,MASKREAD_OFF,4096);
    ...
    // vbrdcst(softin2_y_B,0,MASKREAD_OFF,4096);
    ...
    */
    ...
    vreturn(atemp1_8B,sizeof(atemp1_8B),softin1_x_B,sizeof(softin1_x_B), d1_B,sizeof(d1_B),d2_B,sizeof(d2_B) , a_p_B,sizeof(a_p_B), e_p_B,sizeof(e_p_B) );
