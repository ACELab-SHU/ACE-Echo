...
int Task_nrPDSCHDescramble(
    ...
    __v2048i16 seq2_trans_table_0_vec, __v2048i16 seq2_trans_table_1_vec, __v2048i16 seq2_trans_table_2_vec,
    __v2048i16 seq2_trans_table_3_vec, __v2048i16 seq2_trans_table_4_vec, __v2048i16 seq2_trans_table_5_vec,
    __v2048i16 seq2_trans_table_6_vec, nrPDSCHConfig pdsch, short_struct in_q, short_struct input_sequence_length) {

  uint16_t RNTI           = pdsch.RNTI;
  uint16_t NID            = pdsch.NID;
  short    q              = in_q.data;
  int      sequenceLength = input_sequence_length.data;
  int      init2          = ((RNTI << 15) + (q << 14) + NID) % (1 << 31);
  ...
  vreturn(pbchbits, sequenceLength);
}