/**
 ******************************************************************************
 * @file           : Task_ltePDCCHChanneldecode.c
 * @author         : XiaoxiaoChen
 * @date           : 2024/11/25
...
int K = 43; // (27+16)假设的输入长度，调整大小以适应你的具体输入

int Task_ltePDCCHChanneldecode(__v4096i8 Out0x_0, __v4096i8 Out0x_1, __v4096i8 Out0x_2, __v4096i8 Out1x_0,
